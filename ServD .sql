...
-- --Tipo Servicio-- --
insert into tipoServicio(tipoServicio, descripcion, precioTipoServicio) values ('Reparacion', 'Reparacion de algun electrodomestico o Computadora', 350.00);
insert into tipoServicio(tipoServicio, descripcion, precioTipoServicio) values ('Limpieza', 'Limpieza de algun electrodomestico o Computadora', 250.00);
-- --Servicio-- --
insert into Servicio(lugarServicio, numeroServicio, horaServicio, fechaServicio, codigoTipoServicio) values ('Kinal', 1, '12:00', 11/08/2023, 1);
insert into Servicio(lugarServicio, numeroServicio, horaServicio, fechaServicio, codigoTipoServicio) values ('Burguer King cc Miraflores', 2, '14:00', 15/09/2023, 2);
-- --Medio Transporte-- --
...
-- --Compra-- --
insert into Compra(costoCompra, descripcionCompra, fechaCompra, codigoEmpresa) values(600.00, 'Compra de diferentes herramientas', 
	02/09/2023, 2);
insert into Compra(costoCompra, descripcionCompra, fechaCompra, codigoEmpresa) values(650.00, 'Compra de diferentes utensilios de plastico', 
	14/10/2023, 1);
-- --Servicio_has_Compra-- --
