                ...
                <div class="card-body">
                    <form action="Controlador?menu=Equipo" method="POST">
                        <div class="form-group">
                            <label class="colorLabel" for="dato">Equipo Empleado:</label>
                        ...
                        <div class="form-group">
                            <label class="colorLabel" for="dato">Codigo Equipo:</label>
                            <input type="text" id="" name="" class="form-control">
                        </div>
                        
                        <div class="form-group">
                            <label class="colorLabel" for="dato">Codigo Empleado:</label>
            ...
            <div class="col-sm-11.5" card-table>
                <table class="table table-hover">
                    <thead class="thead thead-hover">
                        <tr>
                            <td><strong>Equipo Empleado</strong></td>
                    ...
                    <tbody>
                        <c:forEach var="equipoEmpleado" items="{equipoEmpleados}">
                            <tr>
                                ...
                                <td>${equipoEmpleado.getEquipo_codigoEquipo}</td>
                                <td>${equipoEmpleado.getEmpleado_codigoEmpleado}</td>
                                <td>
