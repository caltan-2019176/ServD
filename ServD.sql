...
insert into tipoServicio(tipoServicio, descripcion, precioTipoServicio) values ('Renta de equipo', 'Se rentan diferentes tipos de equipo', 500);
insert into tipoServicio(tipoServicio, descripcion, precioTipoServicio) values ('Manejo de bases de datos', 'Se manejan y mejoran bases de datos', 400);
insert into tipoServicio(tipoServicio, descripcion, precioTipoServicio) values ('Mantenimineto de PC', 'Se hace una limpieza general de la PC', 300);
